...
class FractalAnalysisTools:
    ...
    def analyze_linear_region(self, segments, fractal_type=None, plot_results=True,
        ...
        if plot_boxes:
            ...
            self.fractal_analyzer.visualizer.plot_box_overlay(
        ...
        if save_plots:
            ...
            fd, error, intercept = self.fractal_analyzer.box_counter.calculate_fractal_dimension(
    ...
    def analyze_iterations(self, min_level=1, max_level=8, fractal_type=None,
        ...
        if not no_plots and not save_plots and hasattr(self.fractal_analyzer.visualizer, 'plot_dimension_vs_level'):
    ...
    def create_combined_plot(self, segments, box_sizes, box_counts, windows, dimensions,
        ...
        fd, error, intercept = self.fractal_analyzer.box_counter.calculate_fractal_dimension(box_sizes, box_counts)
